...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "\n" +
                "AIzaSyBDCrWcLigfe5BXwMNpoEaB2OadvSSIf8Q" + userMsg;
//                "http://api.brainshop.ai/get?bid=180512&key=OzrMPUwCPxZGslwg&uid=[uid]&msg=[msg]" + userMsg;
